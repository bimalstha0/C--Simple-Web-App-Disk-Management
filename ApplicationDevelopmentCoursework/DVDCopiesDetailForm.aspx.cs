...
{
    public partial class DVDCopiesDetailForm : System.Web.UI.Page
    {
        ...
        protected void BtnAdd_Click(object sender, EventArgs e)
        {
            ...
            string query = "insert into DVDCopy values ('" + TxtCopyNo.Text + "','" + DVDDropDown.SelectedValue + "' ,'" +DateTime.Today+"') ";
